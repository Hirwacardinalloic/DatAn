import exploreTheWorld from '../assets/buto.png'
import youthEmpoweringImg from '../assets/drive.png'
import bookItNow from '../assets/errors.png'
...
const projects=[
    {
        ...
        liveDemo:"https://explore-countries.onrender.com/",
